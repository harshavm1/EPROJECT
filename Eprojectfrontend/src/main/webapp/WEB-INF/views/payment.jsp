...
<c:url value="/resources/js" var="js"/>
	<title>Smart Store| Payment </title>
	<!-- Meta tag Keywords -->
...
<body>
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info stores-electronicsits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> 5605 saptagiri, Bengaluru,India</li>
							<li class="mb-3">
								<i class="fas fa-mobile"></i> +918892956235 </li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> +918660815117 </li>
							<li class="mb-3">
								<i class="fas fa-envelope-open"></i>
								<a href="mailto:example@mail.com"> mail Harsha@gmail.com</a>
							</li>
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2019 Smart Store. All rights reserved.S Harsha</p>
		</div>
	</div>
	<!-- //copyright -->
