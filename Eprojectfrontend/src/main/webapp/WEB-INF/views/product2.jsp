...
<head>
	<title>Electro Store Ecommerce Category Bootstrap Responsive Web Template | Appliances </title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<!-- banner-2 -->
	<div class="page-head_electronics_info_storesl page-head_electronics_info_storesl-2">
